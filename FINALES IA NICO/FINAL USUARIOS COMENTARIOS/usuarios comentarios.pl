...
obtenerListaUsuariosAmigos(Usuario,[H|T]):-usuario(Usuario,_,_,Ciudad,ListaAmigos),
                                           usuario(H,_,_,C,_),
                                           H\=Usuario,
                                           Ciudad == C,
                                           ...
                                           obtenerListaUsuariosAmigos(Usuario,T).
obtenerListaUsuariosAmigos(_,[]).


% obtenerListaUsuariosAmigos(Usuario,ListaUsuariosAmigos):-
% retract(usuario(Usuario,_,_,Ciudad,ListaAmigos)),
