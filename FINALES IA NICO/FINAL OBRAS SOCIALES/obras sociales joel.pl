...
abrirBase:- retractall(persona(_,_,_,_,_)), retractall(obrasocial(_,_,_,_)), consult('C:/Users/Nico/Desktop/FINALES IA NICO/FINAL OBRAS SOCIALES/bd.txt').
