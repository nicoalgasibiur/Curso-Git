...
opciones(1):- writeln('Ingrese camiones: '),
			  leer(ListaCamiones),
...
opciones(2):- writeln('Ingrese conductores: '),
			  ...
			  listaConductores(ListaCOnductoresViajes),nl,nl.
...
listarConductores([H|T]):- conductor(H,AN,_,_,_), write(AN),nl,listaConductores(T).
listarConductores([]).
