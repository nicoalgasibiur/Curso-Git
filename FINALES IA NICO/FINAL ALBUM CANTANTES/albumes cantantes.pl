...
%1)Ingrese un álbum y una lista [] de temas y a partir de esto devolver una lista con aquellos temas de la lista original
%  que correspondan al álbum ingresado.
...
% cuya cantidad de copias supere el millón.
...
menu:-abrir_base,
	  ...
	  writeln('2. Informar cantidad de albumes lanzados en un determinado año por cantantes suecos. Dato entrada: año'),
